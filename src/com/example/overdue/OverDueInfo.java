...
public class OverDueInfo {
	...
	public static String PATH ="http://211.68.37.131/note/recall.jsp?kind=query";
	...
	public static List<Map<String,String>> getNotice(String htmlStr){
		...
		while((a=htmlStr.indexOf("<TR", a))!=-1){
			...
			b = htmlStr.indexOf("&nbsp;",a);
			map.put("tsszg", "图书所在馆："+htmlStr.substring(a, b));
			...
			a = htmlStr.indexOf("<td>", b)+4;
			b = htmlStr.indexOf("&nbsp;",a);
			map.put("gzdw", "工作单位："+htmlStr.substring(a, b));
			...
			a = htmlStr.indexOf("<td>", b)+4;
			b = htmlStr.indexOf("&nbsp;",a);
			map.put("yhrq", "应还日期："+htmlStr.substring(a, b));
			list.add(map);
		}
